...
SWEP.SightMidPoint = { -- Where the gun should be at the middle of it's irons
    Pos = Vector(-1.1, 0, 0.25),
    Ang = Angle(0, 0.15, 0),
}

SWEP.CantPeek = false
SWEP.PeekPos = Vector(2, 2.5, -1.75)
SWEP.PeekAng = Angle(0, 0, -7.5)
...
SWEP.CustomizePos = Vector(10, 32, 3.5)
