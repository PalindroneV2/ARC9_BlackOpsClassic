...
SWEP.Description = [["Picture this scene. Europe, WW2. A band of plucky heores captured by the Germans, but they've got a cunning plan. Darkness falls and they make their escape. Nazi guards firing fruitlessly into the night and the weapon they're using...
... It's the MP40."
...
SWEP.ViewModel = "models/weapons/arc9/c_bo2_mp40.mdl"
SWEP.WorldModel = "models/weapons/w_smg_mp5.mdl"
SWEP.WorldModelMirror = "models/weapons/arc9/w_bo2_mp40.mdl"
SWEP.MirrorVMWM = true
SWEP.NoTPIKVMPos = true
SWEP.WorldModelOffset = {
    Pos        =    Vector(-7.5, 4.5, -5.25),
    Ang        =    Angle(-5, 0.5, 180),
...
SWEP.CustomizePos = Vector(17.5, 35, 5.5)
...
SWEP.Attachments = {
    {
        ...
        Pos = Vector(4, 0, 3.8),
        Ang = Angle(0, 0, 0),
        Category = {"bo2_optic_mauser", "waw_aperture"},
...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
        ...
        Time = 3.25,
        EventTable = {
            {s = "ARC9_WAW.MP40_MagOut", t = 20 / 30},
