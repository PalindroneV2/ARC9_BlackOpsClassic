...
SWEP.Description = [[Fully automatic submachine gun. Increased range and reduced recoil.
It was known as the Modern Sub Machine Carbine (MSMC) prior to 2014.]]
SWEP.Trivia = {
...
SWEP.VisualRecoilSide = 0.08
SWEP.VisualRecoilRoll = 1
SWEP.VisualRecoilPunch = 2.125
...
SWEP.VisualRecoilPunchMultSights = 1 / 2.125
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Ang = Angle(0, 0, 0),
        Category = {"cod_muzzle", "cod_muzzle_pistol"},
    },
    {
