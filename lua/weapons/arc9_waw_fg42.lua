...
SWEP.Trivia = {
    Manufacturer = "Rheinmetall, Heinrich Krieghoff Waffenfabrik",
...
SWEP.WorldModelMirror = "models/weapons/arc9/c_waw_fg42.mdl"
...
SWEP.VisualRecoilUp = 0.333
SWEP.VisualRecoilSide = 0.255
...
SWEP.CustomizePos = Vector(15, 32.5, 4)
