...
SWEP.WorldModelMirror = "models/weapons/arc9/c_bo1_spectre.mdl"
...
SWEP.SightMidPoint = { -- Where the gun should be at the middle of it's irons
    Pos = Vector(-1.9, -0.5, 0.6),
    Ang = Angle(0.0125, 0.225, -2.5),
}
...
SWEP.CustomizePos = Vector(12.5, 30, 6)
...
SWEP.Animations = {
    ...
    ["draw_stock"] = {
        ...
        Time = 1,
        EventTable = {
            {s = "ARC9_BO1.MAC11_Stock", t = 10 / 30},
        },
    },
    ["holster_stock"] = {
        Source = "holster",
    ...
    ["ready_stock"] = {
        ...
        Time = 40 / 30,
        EventTable = {
            {s = "ARC9_BO1.MAC11_Stock", t = 20 / 30},
        },
    },
    ["fire"] = {
        Source = {"fire"},
