...
local Attachments = {
    ...
    ["bo2_thompson_rail"] = {
        PrintName = [[Rapid Capacitor Weapon]],
        CompactName = [[RCW]],
        Icon = Material("entities/bo1_atts/other/fnv_rcw.png"),
        Description = [[Converts the weapon into a Rapid Capacitor Weapon. A bank of rapidly cycling capacitors provides sustained laser fire while the integrated rail accommodates standard optics.]],
        Category = {"bo2_thompson_rail"},
        ActivateElements = {"laserrcw"},
        IronSights = {
        ...
        ShootSound = "ARC9_WAW.LaserRCW_Fire",
        DistantShootSound = {},
        MuzzleParticle = "rgmk2_flash",
        TracerColor = Color(0, 255, 100),
        TracerSize = 3,
        TracerEffect = "boc_generic_laser",
        AlwaysPhysBullet = false,
